                        ...
                        if($password == $cpassword){
                            ...
                            if($result == 0){ //s'il n'y en a aucun
                                ...
                                $message = ' 
                                    ...
                                    <body> 
                                        <p align="center"><img src="images/cloud.png"> alt="nuage" /></p>
                                        <h1>Merci de nous rejoindre! </h1> 
                                        <table cellspacing="0" style="border: thick double #9CE582 ; width: 100%;"> 
                                            
                                            <tr style="background-color: #e0e0e0;"> 
                                                <th>Contact :</th><td>webmaster@serviel.com</td> 
                                            </tr> 
                                            <tr> 
                                                <th>Website:</th><td><a href="serviel.ddns.net:8000">Aller sur votre Cloud</a></td> 
                                            </tr> 
                                        </table> 
                                    </body> 
                                    </html>';
